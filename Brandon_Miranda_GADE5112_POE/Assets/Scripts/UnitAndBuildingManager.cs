...
class UnitAndBuildingManager : MonoBehaviour
{
    public Unit meleeUnitTemplate;
    public Unit rangedUnitTemplate;
    public Unit wizardUnitTemplate;
    public Building factoryBuildingTemplate = null;
    public Building resourceBuildingtemplate = null;
    public Building wizardBuildingtemplate = null;
    ...
    //public void CreateUnit(UnitType unitType, int x, int y, string faction)
    //{
    //    Unit unit = null;
    ...
    //    {
    //        unitgameObject = Instantiate(meleeUnitTemplate.gameObject, null);
    //        MeleeUnit meleeUnit = unitgameObject.GetComponent<MeleeUnit>();
    //        meleeUnit.InitUnit(x, y, faction);
    //        unit = meleeUnit;
    //    }
    //    if (unitType == UnitType.RANGED)
    //    {
    //        unitgameObject = Instantiate(rangedUnitTemplate.gameObject, null);
    //        RangedUnit rangedUnit = unitgameObject.GetComponent<RangedUnit>();
    //        rangedUnit.InitUnit(x, y, faction);
    //        unit = rangedUnit;
    //    }
    //    if (unitType == UnitType.WIZARD)
    //    {
    //        unitgameObject = Instantiate(wizardUnitTemplate.gameObject, null);
    //        WizardUnit wizardUnit = unitgameObject.GetComponent<WizardUnit>();
    //        wizardUnit.InitUnit(x, y, faction);
    //        unit = wizardUnit;
    //    }
    //}
